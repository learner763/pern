      ...
      >
        ...
        <div className="home12">
          ...
          <div className="part2" style={{ display: part2 }}>
            ...
            <label>Name</label>
            <input
              onChange={(e) => setup_name(e.target.value)}
              value={up_name}
              style={{ alignSelf: "end" }}
            ></input>
            <label>About</label>
            <input
              onChange={(e) => setup_bio(e.target.value)}
              value={up_bio}
              style={{ alignSelf: "end" }}
            ></input>
            <button
              onClick={() => update_info(up_user, up_name, up_bio)}
              id="save"
            >
              Save
            </button>
          ...
          <div className="part3" style={{ display: part3 }}>
            ...
            >
              ...
              <option style={{ color: "yellowgreen" }} value="yellowgreen">
                YellowGreen
              </option>
              ...
              <option style={{ color: "goldenrod" }} value="goldenrod">
                Goldenrod
              </option>
            ...
            <button onClick={() => update_settings(pass, bg)} id="save">
              Save
            </button>
          </div>
        </div>
